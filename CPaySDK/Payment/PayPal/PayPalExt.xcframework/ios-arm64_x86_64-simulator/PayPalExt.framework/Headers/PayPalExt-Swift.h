...
#ifndef PAYPALEXT_SWIFT_H
#define PAYPALEXT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayPalExt",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// edges default: 4 // hardEdges 0, softEdges 4, rounded -1 , custom xx
/// size default: expanded// mini, collapsed, expanded, full
...
SWIFT_CLASS("_TtC9PayPalExt12PayPalResult")
@interface PayPalResult : NSObject
...
typedef SWIFT_ENUM(NSInteger, PayPalStatus, open) {
  PayPalStatusStart = 1,
  PayPalStatusComplete = 2,
  PayPalStatusCancel = 3,
  PayPalStatusError = 4,
};
